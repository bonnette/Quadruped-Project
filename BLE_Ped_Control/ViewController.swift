...
class ViewController: UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    @IBAction func Stop(_ sender: Any) {
        ...
        savedPeripheral!.writeValue(Data.init(_: [69]), for: LedSendChar, type: CBCharacteristicWriteType.withResponse)
    ...
    @IBAction func Up(_ sender: Any) {
        ...
        savedPeripheral!.writeValue(Data.init(_: [65]), for: LedSendChar, type: CBCharacteristicWriteType.withResponse)
    }
    ...
    @IBAction func Down(_ sender: Any) {
        ...
        savedPeripheral!.writeValue(Data.init(_: [66]), for: LedSendChar, type: CBCharacteristicWriteType.withResponse)
    }
    ...
    @IBAction func Right(_ sender: Any) {
        ...
        savedPeripheral!.writeValue(Data.init(_: [70]), for: LedSendChar, type: CBCharacteristicWriteType.withResponse)
    }
    ...
    @IBAction func Left(_ sender: Any) {
        ...
        savedPeripheral!.writeValue(Data.init(_: [71]), for: LedSendChar, type: CBCharacteristicWriteType.withResponse)
    }
    ...
    @IBAction func standBtn(_ sender: Any) {
        ...
        savedPeripheral!.writeValue(Data.init(_: [115]), for: LedSendChar, type: CBCharacteristicWriteType.withResponse)
    }
    ...
    @IBAction func squatBtn(_ sender: Any) {
        ...
        savedPeripheral!.writeValue(Data.init(_: [113]), for: LedSendChar, type: CBCharacteristicWriteType.withResponse)
    }
    ...
    @IBAction func waveLeft(_ sender: Any) {
        ...
        savedPeripheral!.writeValue(Data.init(_: [108]), for: LedSendChar, type: CBCharacteristicWriteType.withResponse)
    }
    ...
    @IBAction func waveRight(_ sender: Any) {
        ...
        savedPeripheral!.writeValue(Data.init(_: [114]), for: LedSendChar, type: CBCharacteristicWriteType.withResponse)
    }
